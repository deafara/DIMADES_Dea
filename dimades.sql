...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Des 2022 pada 14.42
...
(1, 'Makanan & Minuman', '', '2022-12-12 06:41:29', '2022-12-12 06:41:29'),
(2, 'Item', '', '2022-12-12 06:41:39', '2022-12-12 06:41:39');
...
(5, '2022_11_28_090207_create_mitras_table', 1),
(6, '2022_11_30_061226_create_kategoris_table', 1),
(7, '2022_12_05_084829_create_products_table', 1);
...
(1, 'admin', 'admin@gmail.com', NULL, '$2y$10$Gvto60k4Bn4suKYH6VyhLOrdEvvF8zzwJW74ESE4roUAkWdVYiLce', '1', NULL, NULL, NULL);
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `kategoris` (`id`) ON DELETE CASCADE,
